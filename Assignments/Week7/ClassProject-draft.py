'''
    Program     :   Assignment Class project - draft
...
def open_weather_connect(options):
    ...
    qStr = {'units' : "imperial", 'appid' : "ff43c714e495ecf805410d0660a6475a"}
    weather_data = None
    ...
    try:
        ...
        if(resp.status_code == 200):
            ...
            if resp.status_code == 404:
                ...
                print(f"Sorry, no data for requested location. Are you that location is on planet Earth?\n")
